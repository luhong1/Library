						...
						<div class="row" style="margin-bottom: 15px">
								<div class="col-md-6">
									<div class="input-group">
										<input type="text" id="txtName" name="txtName"  class="form-control" placeholder="书的名称">
										<span class="input-group-btn">
											<button class="btn btn-default" onclick="ss()" type="button">搜索</button>
										</span>
									</div>
									<!-- /input-group -->
							...
							<div class="col-md-6">
								<a  class="btn btn-primary" id="btn_add"
									style="margin-left: 30px; margin-top: 50px" data-toggle="modal" data-target="#addModal">添加图书</a>
								<a href="#" class="btn btn-danger"
									style="margin-left: 30px; margin-top: 50px" onclick="">
									批量删除</a> <a href="#" class="btn btn-default"
									style="margin-left: 57px; margin-top: 50px">导入书籍</a>
							</div>
								...
								<tr id="show_tab_tr">
									...
									<td>
										<div style="text-align: center;">
											<a href="#" onClick="deletebook(<%=b1.getbId()%>);return false;"
												class="btn btn-danger btn-sm">删除</a>
											<button type="button" class="btn btn-warning btn-xs"
												data-toggle="modal" data-target="#updateModal"
												id="btn_update"
												onClick="showInfo2('<%=b1.getbId()%>','<%=b1.getBookNo()%>','<%=b1.getBookSort()%>','<%=b1.getBookName()%>'
,'<%=b1.getAuthor()%>','<%=b1.getPress()%>','<%=b1.getBookPrice() %>','<%=b1.getBookNum()%>')">修改</button>
										</div>
									</td>
								</tr>
...
<form>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="addISBN"
									required="required" name="bookNo" placeholder="请输入书号">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="addBookName"
									required="required" name="bookSort" placeholder="请输入图书类型">
								<label class="control-label" for="addBookName"
									style="display: none;"></label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="addNum" required="required" name="bookNum" placeholder="请输入图书总数量">
					...
					<div class="modal-footer">
						...
						<button type="submit" class="addBook btn btn-primary">添加</button>
					</div>
				</div>
				<!-- /.modal-content -->
			</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
                      ...
                      <div class="form-group">
							...
							<div class="col-sm-7">
								<input type="hidden" id="bId" name="updatebId">
								<input type="text" class="form-control" id="updatebId"
									name="bId1"  readonly="readonly"> 
									<label class="control-label" for="updatebId" style="display: none;"></label>
							</div>
						</div>
						<div class="form-group">
							<label for="firstname" class="col-sm-3 control-label">图书号</label>
							<div class="col-sm-7">
								...
								<input type="text" class="form-control" id="updateISBN"
									name="bookNo1" placeholder="请输入书号"> <label
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="updateBookName"
									name="bookName1" placeholder="请输入图书名称"> <label
						...
						<div class="form-group">
							<label for="firstname" class="col-sm-3 control-label">图书类型</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" id="updateBookType"
									name="bookSort1" placeholder="请输入图书类型"> <label
									class="control-label" for="updateBookType"
									style="display: none;"></label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="updateAutho"
									name="Author1" placeholder="请输入作者名称"> <label
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="updatePress"
									name="Press1" placeholder="请输入出版社"> <label
									class="control-label" for="updatePress" style="display: none;"></label>
							</div>
						</div>
						
						<div class="form-group">
							<label for="firstname" class="col-sm-3 control-label">图书数量</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" id="updatePrice"
									name="bookPrice1" placeholder="请输入出版社"> <label
									class="control-label" for="updatePrice" style="display: none;"></label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								...
								name="bookNum1" placeholder="请输入出版社"> 
					...
					<div class="modal-footer">
						...
						<button type="submit" class="upDate btn btn-primary">修改</button>
					</div>
				</div>
				<!-- /.modal-content -->
			</div>
	...
	function break1 () {
		...
		if (con) {
			...
			//修改和删除书籍函数
			function showInfo2(bId, bookNo, bookSort, bookName, Author, Press, bookPrice,bookNum) {
				document.getElementById("updatebId").value = bId;
				document.getElementById("updateISBN").value = bookNo;
				document.getElementById("updateBookName").value = bookName;
				document.getElementById("updateAutho").value = Author;
				document.getElementById("updatePress").value = Press;
				document.getElementById("updateBookType").value = bookSort;
				document.getElementById("updateNum").value = bookNum;
				document.getElementById("updatePrice").value = bookPrice;
			...
			function deletebook(bid) {
				...
				if (con) {
					window.location.href = "http://120.26.187.198:8080/Library/delBookServlet?bId=" + bid;
				}
			}
 ...
 <script type="text/javascript">
	...
	$(function(){ 
		...
		$(".sub-btn4").on("click", function(){
    		...
    		var $bookNo=$("input[name=bookNo]");
    		var data = {};
    		data.bookName = $.trim($("input[name=bookName]").val());
    		data.bookSort = $.trim($("input[name=bookSort]").val());
    		data.Author = $.trim($("input[name=Author]").val());
    		data.Press = $.trim($("input[name=Press]").val());
    		data.bookPrice = $.trim($("input[name=bookPrice]").val());
    		data.bookNum = $.trim($("input[name=bookNum]").val());
    		data.bookNo = $.trim($bookNo.val());
    		$.ajax({
    	        url: "http://120.26.187.198:8080/Library/addBookServlet",
    	        async : true,
    	        type: "post",
    	        dataType: "text",
    	        data: data,
    		...
    		var $bookNo=$("input[name=bookNo1]");
    		var data = {};
    		data.bId = $.trim($("input[name=bId1]").val());
    		data.bookName = $.trim($("input[name=bookName1]").val());
    		data.bookSort = $.trim($("input[name=bookSort1]").val());
    		data.Author = $.trim($("input[name=Author1]").val());
    		data.Press = $.trim($("input[name=Press1]").val());
    		data.bookPrice = $.trim($("input[name=bookPrice1]").val());
    		data.bookNum = $.trim($("input[name=bookNum1]").val());
    		data.bookNo = $.trim($bookNo.val());
    		$.ajax({
    	        url: "http://120.26.187.198:8080/Library/upBookServlet",
    	        async : true,
    	        type: "post",
    	        dataType: "text",
    	        data: data,
    	        success: function (data) {
    	        	...
    	        	if(data =='-4'){
    	        		$("#form-ipt-error-cl-update").addClass("is-visible");
    	                $("#form-ipt-error-cl-update").prev().addClass("input-error");
    	    			$("#form-ipt-error-cl-update").html("未知错误");
    	        		alert("未知错误");
    	        		return ;
    	        	}   
    	        }
