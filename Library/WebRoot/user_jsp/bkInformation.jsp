		  	...
		  	<h1 class="page-header">借书板块</h1>
				...
				<div class="panel panel-primary">
					...
					<div class="panel-heading">
						书籍信息 <i class="fa fa-thumb-tack pull-right"></i>
					</div>
					...
					<div class="panel-body">
					   ...
					   <td width="50%">
						  <% 
						     ...
						     Book  book=bookService.getBookInfo(bId);
						  %>
						  <font color="gray">书名：<%=book.getBookName() %></font><br>
						  ...
						  价格：<font color="red"><%=book.getBookPrice() %></font>
						  </td>
						  </tr> 
						  </table>
						</form>
				...
				<div class="row">
            <button type="button" onclick="borrowbook(<%=book.getbId() %>)" class="btn btn-primary" style="width: 150px;margin-left: 45%">借阅</button> 
				</div>
						</div>
						</div>
			</div>
...
function borrowbook(bId) {
	...
	var con = confirm("是否借阅?");
	if (con) {
		window.location.href= "http://120.26.187.198:8080/Library/borServlet?flag=1&bId="+ bId;
	}
	}
}
function break1 () {
